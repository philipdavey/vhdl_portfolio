# ====================================================================
# File Name     : decryption_tb_run.tcl
# Author        : Philip Davey
# Design Folder : AES
# Date          : February 2022
# --------------------------------------------------------------------
...
vcom -2008 +cover -work ../output/work ../../rtl/inv_shift_rows_rtl.vhd
vcom -2008 +cover -work ../output/work ../../rtl/inv_mix_columns_rtl.vhd
...
vcom -2008 +cover -work ../output/work ../src/decryption_tb.vhd
